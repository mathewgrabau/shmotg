    ...
    ej.widget("ejPager", "ej.Pager", {
        ...
        _renderNumericLinks: function ($numericContainer) {
            ...
            for (var page = 1; page <= this.model.pageCount; page++) {
                var $link = ej.buildTag('a.e-link', page, {}, { role: "link" }).addClass("e-numericitem e-spacing e-default");
        ...
        _applyCss: function () {
            ...
            if (parseInt(this._links[0].innerHTML, 10) + this.model.pageCount > this.model.totalPages)
                this._lastNP = true;
            else
                this._lastNP = false;
        ...
        _pagerClickHandler: function (e) {
            ...
            if ($.inArray(e.target, this._links) != -1) {
                this.model.currentPage = parseInt(e.target.innerHTML, 10);
                ...
                if (parseInt(this._links[this.model.pageCount - 1].innerHTML, 10) + this.model.pageCount >= this.model.totalPages) {
                    ...
                    (this._LastpageCount == 0) ? (this._LastpageCount = this.model.pageCount) : null;
                    if (this._links != undefined)
                        this.model.currentPage = parseInt(this._links[this.model.pageCount - 1].innerHTML, 10) + 1;
                }
            }
            ...
            this.goToPage(this.model.currentPage);
            return false;
        },
